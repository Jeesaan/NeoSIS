        ...
        <div class="container" style="border: 2px solid;">
            <div class="row">
                ...
                <div class="col-sm-12 btn-group-vertical">
                    <br/>                        
                    <center><h1>Export Student Data to Excel!!!</h1></center>
                    <form action="ste.php" method="POST">                  
                    <select id="depttype" class="selectpicker form-control" data-live-search="true">
                        <?php echo $options1;?>
                    </select><br/><br/>
